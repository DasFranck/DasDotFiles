...
sudo pacman -S --noconfirm i3 zsh firefox man htop terminology pavucontrol dmenu adobe-sourcecodepro-fonts yaourt numlockx xorg xorg-xinit feh conky
...
(cp -f zshrc /home/dasfranck/.zshrc && echo "zsh configuré avec succès") 
|| echo "Erreur dans la configuration de zsh"

#Configuration de oh-my-zsh
(cp -f das.zsh-theme /home/dasfranck/.oh-my-zsh/themes/ && echo "Thème Das de oh-my-zsh installé avec succès") 
|| echo "Erreur dans l'installation du thème Das de oh-my-zsh"

#Configuration de xinit
(cp -f xinitrc /home/dasfranck/.xinitrc && echo "xinit configuré avec succès") 
|| echo "Erreur dans la configuration de xinit"

#Configuration de i3
(cp -f i3/config /home/dasfranck/.i3/config && echo "i3 configuré avec succès") 
|| echo "Erreur dans la configuration de i3"

#Configuration de i3status
(cp -f i3status.conf /home/dasfranck/.i3status.conf && echo "i3status configuré avec succès") 
|| echo "Erreur dans la configuration de i3status"

#Configuration de vim
(cp -f vimrc /home/dasfranck/.vimrc && echo "vim configuré avec succès") 
|| echo "Erreur dans la configuration de vim");

#Installation du colorsheme vim
(cp -f jellybeans.vim /home/dasfranck/.vim/colors/jellybeans && echo "jellybeans.vim installé avec succès") 
